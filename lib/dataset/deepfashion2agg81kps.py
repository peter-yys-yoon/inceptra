...
from dataset.deepfashion2agg81kps_util import convert_back, get_deepfashion2ahh81kps_flip_map
...
class Deepfashion2Agg81KpsDataset(JointsDataset):
    '''
    "keypoints": {
        0: "nose",
        1: "left_eye",
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        print(__file__, 'self.coco',self._get_ann_file_keypoint() )
        ...
        keypoint_flip_map, keypoint_flip_map_idx = get_deepfashion2ahh81kps_flip_map()
        self.flip_pairs = keypoint_flip_map_idx
        print('flip pairs:', self.flip_pairs)
    ...
    def _get_ann_file_keypoint_ori(self):
        """ self.root / annotations / person_keypoints_train2017.json """
        prefix = self.image_set # train, validation, test
        return os.path.join(
             './data/deepfashion2/annotations', prefix + '.json'
        )
    ...
    def image_path_from_index(self, index):
        ...
        if 'train' in self.image_set:
            ...
            print('ERROR!!!!!!!!!!!!!!!!!!!!!!!! in def image_path_from_index')
        image_path = os.path.join(self.root, 'images', t, file_name)
            ...
            result = [
                {
                    ...
                    'keypoints': convert_back(list(key_points[k])),
    ...
    def _do_python_keypoint_eval(self, res_file, res_folder):
        ...
        coco = COCO(self._get_ann_file_keypoint_ori())
