...
import deepfashion2agg81kps_util
...
if __name__ == '__main__':
    ...
    alist =[ 'train_debug.json','validation_debug.json',
                'train.json','validation.json']
    
    outpath = '../../data/deepfashion2agg81kps/annotations'
    if not os.path.exists(outpath):
        os.makedirs(outpath)

    for aa in alist:    
        infile = f'../../data/deepfashion2/annotations/{aa}'
        outfile = f'{outpath}/{aa}'
